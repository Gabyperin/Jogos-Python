...
margin = Canvas(root, width=500, bg='#fff', height=100,  # noqa: F405
                bd=0, highlightthickness=0, relief='ridge')
margin.pack()
text_id = Label(root, bg='#555555', text='Lula é LADRAO???',  # noqa: F405
                fg='#fff', font=('Montserrat', 24, 'bold'))
text_id.pack()
button_1 = tk.Button(root, text='Não', bg='#666666', command=denied,
                     relief=RIDGE, bd=3, font=('Montserrat', 8, 'bold'))  # noqa: F405
button_1.pack()
root.bind('<Motion>', move_button_1)
button_2 = tk.Button(root, text='Sim', bg='#666666', relief=RIDGE,  # noqa: F405
